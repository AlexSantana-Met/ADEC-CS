...
public class Correcto extends JFrame {
    ...
    public Correcto(String mensaje) {
        initComponents();
        ...
        this.img.setIcon(new ImageIcon("images/inbox_done2.png"));
        this.barra.setIcon(new ImageIcon("images/barra.png"));
        this.eti1.setText(mensaje);
    }
    ...
    public void initComponents() {
        ...
        eti1.setBounds(90, 50, 320, 130); 
       
        getContentPane().add(barra);
        barra.setBounds(0, 0, 450, 40);
        
        fondo.setOpaque(true);
        getContentPane().add(fondo);
        fondo.setBounds(0, 0, 450, 200);
...
//        new Correcto("Correcto el proceso").setVisible(true);
//    }
